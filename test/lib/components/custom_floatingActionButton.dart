...
class _CustomFloatingActionButton extends State<CustomFloatingActionButton> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("FloatingActionButton 커스텀"),
        ...
        floatingActionButton: SpeedDial(
          ...
          backgroundColor: AppColor.GRAY, //background color of button
          foregroundColor: Colors.white, //font color, icon color in button
          activeBackgroundColor:
              AppColor.ORANGE, //background color when menu is expanded
